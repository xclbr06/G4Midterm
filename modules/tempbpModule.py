...
def celsius_to_fahrenheit():
    while True:
        celsius = get_float("Enter Celsius: ", allow_negative=True)
...
def fahrenheit_to_celsius():
    while True:
        fahrenheit = get_float("Enter Fahrenheit: ", allow_negative=True)
